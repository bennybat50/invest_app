          ...
          child: ListView(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Let's Get Started With\nYour Email Address", style: TextStyle(fontSize: 25, 
                 fontWeight: FontWeight.bold, color: Color(0xFF303e67),),),
              ),
              Text('You will use this as your login.', style: TextStyle(fontSize: 15),),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 10),
                child: Text('E-Mail Address', style: TextStyle(fontSize: 10),),
              ),
              TextFormField(
                   controller: registerEmail,
                  decoration: InputDecoration(
                    labelText: 'Enter a valid e-mail address',
